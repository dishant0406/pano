...
const Detail = ({ title, description, image }: { title: string, description: any, image: string }) => {
  ...
  return (
    <div onMouseEnter={() => {
      ...
      setIsHover(false)
    }} className='w-full cursor-pointer md:h-[50vh] md:py-0 py-[5vh] relative md:px-[5%] flex items-center justify-center md:justify-end'>
      <Image alt='bg'
      ...
      <div className='z-[2] w-[95vw] md:w-[40vw]'>
        <p className='text-white md:text-start text-center text-[4vh] md:text-[6vh] '>
          {title}
        </p>
        <p className='text-white  md:text-start text-center mt-[2%] z-[1] text-[1.5vh] md:text-[2vh]'>
          {description}
        </p>
      </div>
    </div>
