...
const CTA = (props: Props) => {
  return (
    <div className='w-full flex flex-col items-center overflow-hidden relative h-[90vh] mt-[10vh]'>
      <div className='w-full flex justify-center bottom-[-60%] left-0 absolute'>
      ...
      <button className='bg-none mt-[3%] border-[3px] transition-all duration-300 hover:shadow-[0px_0px_45px_2px_rgba(244,_197,_92,_0.25)] border-[#F7D079] text-white rounded-[5rem] px-[3rem] py-[1rem] text-[20px]'>
        Join Us
      </button>
    </div>
  )
