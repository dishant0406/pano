  ...
  return (
    <>
      ...
      <div className='mb-[10vh] w-full flex items-center flex-col'>
        ...
        <p className='text-white text-center mt-[2%] w-[50vw] leading-[4vh] z-[1] text-[2vh]'>
          $PANO is not just another cryptocurrency; it is the lifeblood of our immersive gaming universe. As an artist-driven project, we are creating a unique gaming experience where players can immerse themselves in captivating virtual worlds, conquer challenges, and earn real rewards powered by $PANO .
